              ...
              >
                <div className="flex items-center gap-3">
                  <Globe
                    className={cn(
                      "w-5 h-5",
                      activeGatewayId === gateway.id ? "text-primary" : "text-muted-foreground"
                    )}
                  />
                  <div>
                    <div className="font-bold text-sm">{gateway.name}</div>
                    <div className="text-[10px] opacity-50 truncate max-w-[150px]">
                      {gateway.url}
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-4 bg-secondary/30 p-4 rounded-2xl border border-border/50">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <VerboseToggle value={showTools} onChange={onShowToolsChange} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold text-muted-foreground uppercase ml-1">
                    Reasoning
                  </label>
                  <ReasoningToggle value={showReasoning} onChange={onShowReasoningChange} />
                </div>
              </div>
            </div>
          </section>
