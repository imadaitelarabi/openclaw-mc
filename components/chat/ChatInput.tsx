    ...
    <div className="p-3 md:p-4 border-t border-border bg-background/50 backdrop-blur">
      <div className="max-w-4xl mx-auto flex gap-2 md:gap-3 items-end">
        <textarea
          ...
          className="flex-1 bg-secondary/50 border border-border rounded-lg px-3 py-2 md:px-4 md:py-3 focus:outline-none focus:border-primary/50 font-sans resize-none overflow-hidden min-h-[40px] md:min-h-[46px] text-sm md:text-base"
          rows={1}
          autoFocus
          disabled={disabled}
        />
