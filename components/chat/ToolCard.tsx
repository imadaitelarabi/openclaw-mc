...
export function ToolCard({ message }: ToolCardProps) {
  ...
  return (
    <div className={`max-w-[85%] rounded-lg p-4 border backdrop-blur transition-all duration-300 ${cardClasses}`}>
      <div className="flex items-center gap-2 mb-2">
        {/* Status icon */}
        {isPending && <Loader2 className="w-4 h-4 text-amber-600 dark:text-amber-400 animate-spin" />}
